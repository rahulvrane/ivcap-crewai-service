...
from crewai_tools import SerperDevTool, WebsiteSearchTool, DirectorySearchTool, DirectoryReadTool, PDFSearchTool
import litellm
...
directory_read_tool = DirectoryReadTool(directory="/Users/ran12c/development/ivcapworks/ivcap-crewai-service/examples/input_documents")
#directory_search_tool = DirectorySearchTool(directory="/Users/ran12c/development/ivcapworks/ivcap-crewai-service/examples/input_documents")
...
researcher = Agent(
    ...
    goal=(
        ...
        " the requester context {additional_info}. and also use the DirectoryReadTool to read the content of the directory and summarise the documents"
    ),
    backstory=(
    ...
    memory=False,
    tools=[ directory_read_tool, pdf_search_tool],
)
